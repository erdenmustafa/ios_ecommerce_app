...
/*
 Swift.DecodingError.Context(codingPath: [CodingKeys(stringValue: "Products", intValue: nil), _JSONKey(stringValue: "Index 0", intValue: 0), CodingKeys(stringValue: "bilgiler", intValue: nil), _JSONKey(stringValue: "Index 13", intValue: 13), CodingKeys(stringValue: "images", intValue: nil)], debugDescription: "Expected to decode Array<Any> but found a string/data instead.", underlyingError: nil))
 */
